...
only_samples_df <- subset(reduced_normal_data_df, Case_ID != "Case08" & Case_ID != "Case59") 
#View(only_samples_df)


#Do quantile normalization
 
remove_list = c("Sample_Status", "Case_ID")
before_quantile_df = only_samples_df[,which(colnames(only_samples_df) %nin% remove_list)] 
...
quantile_df$Case_ID = only_samples_df$Case_ID
quantile_df$Sample_Status = only_samples_df$Sample_Status
