...
scatterplot1
pdf("../RA_Autoantibodies_2022/output/scatter_plot1.pdf")
scatterplot1
dev.off()
...
pdf("../RA_Autoantibodies_2022/output/ternary_plot1.pdf")
ternary_plot1
dev.off()
...
pdf("../RA_Autoantibodies_2022-main/output/ternary_plot2.pdf")
ternary_plot2
dev.off() 
