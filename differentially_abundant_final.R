...
normal_data_df <- read.csv("normal_sengenics_data_rows_as_samples.csv")
#View(normal_data_df)
...
class_labels_df = read.csv("../RA_Autoantibodies_2022/class_labels_with_sample_ID_no_spaces.csv")
...
only_92_samples_df <- subset(reduced_normal_data_df, Case_ID != "Case028292" & Case_ID != "Case028399") 
...
#write.csv(quantile_92_df, "../RA_Autoantibodies_2022/QN_sengenics_data_with_class.csv", row.names=FALSE, quote=FALSE)
...
pdf("../RA_Autoantibodies_2022/output/higher_in_ACPA_pos_than_control.pdf")
...
pdf("../RA_Autoantibodies_2022/output/higher_in_control_than_ACPA_pos.pdf")
...
pdf("../RA_Autoantibodies_2022/output/higher_in_ACPA_neg_than_control.pdf")
...
pdf("../RA_Autoantibodies_2022/output/higher_in_control_than_ACPA_neg.pdf")
Control_ACPA_neg_plot
dev.off()
